...
export default function Sidebar() {
  ...
  return (
    <>
      <div class={`p-4 bg-gray-800 text-white h-screen transition-width duration-500 relative ease-out truncate flex-col flex ${!isOpen() ? "w-24" : "w-[400px]"}`}>
        <div class="flex mb-2 p-3">
