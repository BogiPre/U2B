...
export default function Sidebar() {
  ...
  return (
    <>
      <div class={`p-4 bg-gray-800 text-white h-screen transition-width duration-500 relative ease-out flex-col flex ${!isOpen() ? "w-24" : "w-[400px]"}`}>
        <div class="flex mb-2 p-3 justify-around gap-8">
          ...
          {isOpen() && <h1 class={`text-xl pt-0.5`}>Convert Video or Playlist!</h1>}
        </div>
