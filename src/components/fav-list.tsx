...
export default function FavList() {
    ...
    return (
        <div class={`p-4  text-white h-screen duration-500 ease-out flex-col flex-shrink-0 flex right-0 truncate ${!isOpen() ? "opacity-100 sm:w-24 sm:bg-gray-800 absolute sm:relative flex-shrink-0" : "absolute sm:relative w-full sm:w-[400px] bg-gray-800"} ${location.pathname === '/' ? "hidden" : "visible"}`}>
